...
rem wayne931121_jupyter_notebook_config in https://github.com/wayne931121/conda_activate_environment_bat/tree/main/attachment
...
jupyter notebook --config="C:\Users\原神\Downloads\wayne931121_jupyter_notebook_config"
